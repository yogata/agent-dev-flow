...
1. 現行 REQ: `docs/requirements/REQ-0101.md` ～ `docs/requirements/REQ-0140.md`（REQ-0111, REQ-0115, REQ-0116, REQ-0117, REQ-0118, REQ-0120, REQ-0121, REQ-0122 は廃止）。
...
本プロジェクトは case-run コマンドの実行ハーネスとして [oh-my-openagent](https://github.com/code-yeongyu/oh-my-openagent) を選定する。

- 起動方法の詳細は `src/opencode/skills/agentdev-case-run-execution-adapter/references/oh-my-openagent.md` 参照
- oh-my-openagent 不在時は case-run がエラー停止する（フォールバック経路なし）
