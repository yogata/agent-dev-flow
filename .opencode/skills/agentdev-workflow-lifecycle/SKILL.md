...
- Pattern A-Dの分類（バグ修正・軽微変更/機能追加/リファクタリング・保守作業/ドキュメント・雑務）と規模判定（機能追加）
...
| intake-promote | レビュー済み intake item を後続コマンドに渡せる artifact に整形 |
| intake-open | intake-promote 生成 artifact から GitHub Issue 作成 |
| learning-refine | inbox.md と archive.md をセマンティック分析し evaluation-report 出力 |
