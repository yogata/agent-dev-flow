...
| `req-backlog` | promoted artifact から RU を生成。intake item 群から learning item を作成しない |
...
Epic モード時、case-close は対象 PR だけでなく、関連する子 Issue PR 群の本文を横断走査して Finding を回収する（REQ-0040-008）。
