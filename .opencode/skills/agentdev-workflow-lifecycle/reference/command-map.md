...
/agentdev/learning-refine(inbox → archive + evaluation-report) → /agentdev/learning-promote → .agentdev/learning/promoted/ → /agentdev/req-define(明示入力ファイル)
```
