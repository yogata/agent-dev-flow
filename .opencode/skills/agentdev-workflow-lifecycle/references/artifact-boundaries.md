...
- 成果物の詳細なライフサイクルは [`references/artifact-lifecycle.md`](./artifact-lifecycle.md) を参照
...
- **成果物ライフサイクル**: [`references/artifact-lifecycle.md`](./artifact-lifecycle.md)
- **Pattern Registry**: [`references/pattern-registry.md`](./pattern-registry.md)