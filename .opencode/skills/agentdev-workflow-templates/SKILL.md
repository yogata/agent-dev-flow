...
| `issue_desc_epic.md` | Epic Issue本文 | case-open (Epic flow) | B (Epic) |
| `issue_desc_child.md` | 子Issue本文 | case-open (Epic flow) | B (Epic) |
| `issue_desc_backlog_epic.md` | バックログEpic | intake-open | D |
| `issue_desc_backlog_child.md` | バックログ子Issue | intake-open | D |
