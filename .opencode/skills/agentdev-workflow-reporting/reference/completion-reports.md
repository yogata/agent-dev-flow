...
|----------|---------|-------------|----------|
| req-define | feature | `req-define/feature.md` | Pattern B standard（機能追加） |
| req-define | feature-epic | `req-define/feature-epic.md` | Pattern B Epic（大規模機能追加） |
| req-define | bug-or-lightweight | `req-define/bug-or-lightweight.md` | Pattern A（バグ修正・軽微変更） |
| req-define | maintenance | `req-define/maintenance.md` | Pattern C（保守作業） |
| req-define | docs-or-chore | `req-define/docs-or-chore.md` | Pattern D（ドキュメント・雑務） |
...
| req-backlog | standard | `req-backlog/standard.md` | 全RU生成成功 |
| req-backlog | partial | `req-backlog/partial.md` | 部分成功（矛盾・失敗あり） |
| req-backlog | zero-promoted | `req-backlog/zero-promoted.md` | promoted artifact 0件 |
