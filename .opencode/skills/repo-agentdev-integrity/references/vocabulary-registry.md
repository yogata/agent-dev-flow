...
## RFC 2119 語彙（REQ-0102-024〜028, REQ-0115-044）

| 旧語彙 | 現行語彙 | 備考 |
|--------|----------|------|
| `SHALL` | 必達要件記述 | RFC 2119 keyword（REQ-0102-024） |
| `SHOULD` | 必達要件記述または推奨表現 | RFC 2119 keyword（REQ-0102-025） |
| `MAY` | 許可表現（「〜してよい」） | RFC 2119 keyword（REQ-0102-026） |
| `MUST` | 必達要件記述 | RFC 2119 keyword（REQ-0102-027） |
| `（SHALL）` | （不要、必達要件として記述） | 括弧付き RFC 2119 marker（REQ-0102-028） |
| `（SHOULD）` | （不要、必達要件として記述） | 括弧付き RFC 2119 marker（REQ-0102-028） |
| `（MAY）` | （不要、許可表現として記述） | 括弧付き RFC 2119 marker（REQ-0102-028） |
| `RFC 2119` | 必達要件 | SPEC 必達要件ルール全体（REQ-0102-024） |
