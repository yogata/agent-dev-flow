...
3. PRマージ（`gh pr merge`）→ 対応記録をIssueにコメント追記 → テンプレート: @.opencode/commands/issue/templates/issue_comment_feature_implementation.md or @.opencode/commands/issue/templates/issue_comment_bug_record.md
