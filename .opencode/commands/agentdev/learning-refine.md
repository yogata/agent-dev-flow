...
learning-refine が扱う3つの成果物の役割・性格・ライフサイクル振る舞いを以下に定義する。各 artifact の性質を誤解しないことが、パイプライン全体の正しい運用において必須である（REQ-0105, REQ-0105, REQ-0105, REQ-0105, REQ-0105, REQ-0105）。
