...
- **IR-056（project doc-inputs 整合性）**: `check_doc_inputs.ts`（`.opencode/skills/repo-agentdev-integrity/scripts/check_doc_inputs.ts`）を併せて実行し、IR-056 として strict に取り扱う（ADR-0133、REQ-0157）。check_doc_inputs.ts の strict failure は docs-check 全体を fail とする
