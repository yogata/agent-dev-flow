...
| [REQ-0103](REQ-0103.md) | Artifact責任分界 | command / skill / template / script / namespace |
...
| [REQ-0108](REQ-0108.md) | Integrity / Validation / Tests | 整合性検査、validation、guardrails、体系的テスト |
