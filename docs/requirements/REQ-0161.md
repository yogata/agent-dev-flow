...
| REQ-0161-004 | 削除後の rg "ADR-0133\|REQ-0157\|project-doc-inputs\|config\.yaml" docs/ が、検査対象ファイル自身の記述（REQ-0161.md の要件行、docs/README.md および docs/requirements/README.md の REQ-0161 エントリ行）を除外した結果 0件であること（自己参照の構造的過剰ヒットを排除するため） |
