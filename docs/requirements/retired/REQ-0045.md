...
ワークフローのマクロフェーズ構成、Pattern体系、SSoT遷移、エラー回復方針を含む。
...
| REQ-0045-003 | 壁打ちフェーズから構造的実行フェーズへの境界で、docs変更をコミット、プッシュすること（SHALL） |
...
| REQ-0045-005 | Pattern Bで規模判定基準（複数モジュール跨ぎ、PR肥大化リスク、段階的リリース）のいずれかを満たす場合、Epic規模として扱うこと（SHALL） |
