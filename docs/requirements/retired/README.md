...
- REQ-0157 は Project Doc Inputs Migration の概念を project-extensions 機構（.agentdev/extensions/**）へ全面置換し retired となった（2026-07-04、ADR-0135 採用）。schema・配置・命名が非互換に変わるため移行ではなく置換。内容は REQ-0160 として再定義。`migrated` 扱い。
