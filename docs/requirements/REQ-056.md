...
| REQ-056-010 | docs/knowledge/ の正規配置・命名・必須内容を機械検査できること。検査範囲は本体 5 項目に加え frontmatter（title / created / updated）、および知識領域 README（docs/knowledge/README.md）の知識文書列挙と実ファイルの過不足（README 列挙整合）を含むこと |
