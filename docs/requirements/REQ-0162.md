...
- **関連 REQ**: REQ-0139（外部エージェント統合契約）、REQ-0119（責務分界）、REQ-0146（実行契約・委譲・プロセス設計）、REQ-0130（case-run）、REQ-0114（case-auto）、REQ-0151（コンフリクト解消）、REQ-0163（subagent 委譲プロトコル要件・adapter skill 経由の委譲契約）
