...
| REQ-006-114 | blocked の場合のみ Root Case に resume_command を保持し、停止解除後の正規再開入口を永続化すること。resume_command は通常状態への遷移時にクリアすること。新しい意味判断が必要な場合は req-define を指し、再合意済みで case-revise 自体の再開が必要な場合は case-revise を指せること |
