...
| REQ-0106-027 | `agentdev-workflow-orchestration` スキルの Wave scheduling 手順にファイル変更範囲の非重複チェックを追加すること |
| REQ-0106-028 | `agentdev-workflow-orchestration/references/self-healing-and-errors.md` にマージコンフリクト予防のガイダンスを追加すること |
