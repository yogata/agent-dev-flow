...
現行 Decision は DEC-001 から DEC-042 の41件である（DEC-002、DEC-005、DEC-007、DEC-015、DEC-017、DEC-029、DEC-030 は superseded、DEC-042 は proposed）。
...
| [DEC-042](decisions/DEC-042.md) | case-auto 最大並列維持と同期逐次フォールバック禁止（proposed） |
