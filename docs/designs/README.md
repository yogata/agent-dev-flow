...
| foundations/model-escalation-runtime.md | accepted | OpenCode 同一セッションモデル昇格ランタイム | REQ-053 の実装詳細（ADF 共通設定ファイル schema、昇格要求受付、ターン境界切替メカニズム、状態保持、通知、失敗報告と無限反復防止、配布経路） |
