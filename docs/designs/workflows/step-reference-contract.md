...
| 変種 | 形式 | 該当例 |
|---|---|---|
| h3 見出し形式（標準） | `### Purpose` 〜 `### Resume-Idempotency` | Wave 2 移行の Workflow Skill（req-define、case-open、case-ready、case-revise、case-run、case-auto、intake-promote、learning-promote、backlog-review 等） |
