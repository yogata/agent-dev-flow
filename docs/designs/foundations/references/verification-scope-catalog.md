...
- REQ-056-001..REQ-056-005: 技術固有知識の所有分担、extension 機構への名レベル参照、workflow からの利用、知識成長サイクル、Knowledge 文書種別非依存の原則と実行時振る舞い。REQ 構造診断とレビューで検証
