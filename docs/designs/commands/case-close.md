...
- [workflows/v4-runtime-execution-model.md](../workflows/v4-runtime-execution-model.md)（Epic Issue 本文の直列化〔per-Epic 単一書き手〕。Epic Wave クローズ運用は本 Design「Epic Wave クローズ」節）
