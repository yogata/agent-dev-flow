...
- コマンド名、スキル名、ファイル名、ディレクトリパス（`/agentdev/req-define`、`agentdev-req-analysis`、`docs/designs/foundations/system.md`）
...
- **文章表層検査**: `agentdev-textlint-guard` Plugin の標準規則とプロジェクト用語 prh 辞書
