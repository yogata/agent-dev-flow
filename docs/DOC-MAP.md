...
> **非正本文書**: DOC-MAP は文書探索・参照経路の入口であり、要件の正本ではない（REQ-0035 / ADR-0008）。
> 正本は各 `REQ-{NNNN}.md`、`ADR-{NNNN}.md`、`specs/*.md` ファイルである。

## 正本境界

| 文書種別 | 正本 | 役割 |
|----------|------|------|
| REQ | `requirements/REQ-{NNNN}.md` | 要件定義の永続正本 |
| ADR | `adr/ADR-{NNNN}.md` | アーキテクチャ決定記録の正本 |
| SPEC | `specs/*.md` | 現在アーキテクチャの正本（REQ-0035-006） |
| DOC-MAP | このファイル | 文書探索入口（非正本・分類索引） |
