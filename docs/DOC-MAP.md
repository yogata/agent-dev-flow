...
| [REQ-0115](requirements/REQ-0115.md) | docs-* command suite 定義 | /repo/docs-check 改名、/agentdev/inspect-docs 新設、inspect-docs 統合、是正ルーティング |
...
| [診断・メンテナンス](guides/diagnostics-and-maintenance.md) | docs-check（/repo/docs-check: self-hosting repo専用自己監査） / inspect-docs |
