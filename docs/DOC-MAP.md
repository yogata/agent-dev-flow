...
| [targeted-docs-guard-implementation.md](specs/integrity/targeted-docs-guard-implementation.md) | check_changed_docs.ts 変更文書限定検査契約の実装計画（Phase 1-6）・report フィールド一覧（REQ-0158 から HOW を移送、AG-012） |
