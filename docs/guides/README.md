...
利用者向けの参照用読み物（navigation 層）。規範的権限を持たない。基準は各 REQ/ADR/SPEC ファイルであり、ガイドは基準を代替しない。基準文書と矛盾する記述がある場合は基準を優先する。

> **Navigation 層**: ガイドは人間向けの案内・探索支援を目的とする。規範表現を含まず、REQ/ADR/SPEC の内容を重複して記述しない（ADR-0103）。
...
| [診断・メンテナンス](diagnostics-and-maintenance.md) | docs-check / docs-review |
