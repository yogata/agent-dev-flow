...
利用者向けの参照用読み物（案内層）。基準は各 REQ/ADR/SPEC ファイルであり、ガイドは基準への導線を提供する。基準文書と矛盾する記述がある場合は基準を優先する。

> **案内層**: ガイドは人間向けの案内、探索支援を目的とする（REQ-0101-014, 027、ADR-0103）。REQ/ADR/SPEC の内容は基準文書を参照する。
