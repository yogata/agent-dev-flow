...
| REQ-0101 | 65 | +1 | 文書、REQ 管理基準 |
| REQ-0102 | 65 | +1 | 要件定義、保存 |
| REQ-0112 | 55 | +1 | ADR ライフサイクル |
| REQ-0108 | 53 | +1 | docs-check / Validation |
| REQ-0104 | 51 | +1 |  |
| REQ-0140 | 41 | +0 |  |
| REQ-0138 | 33 | +0 |  |
| REQ-0141 | 33 | +0 |  |
| REQ-0119 | 32 | +0 | コマンド、スキル責務分界 |
| REQ-0130 | 32 | +0 |  |
| REQ-0131 | 32 | +0 |  |
| REQ-0132 | 28 | +0 |  |
| REQ-0144 | 28 | +0 |  |
| REQ-0109 | 26 | +0 |  |
| REQ-0136 | 25 | +0 | REQ/SPEC/ADR 適正運用自動化 |
| REQ-0148 | 24 | +0 |  |
| REQ-0127 | 22 | +0 |  |
| REQ-0124 | 21 | +0 |  |
| REQ-0145 | 18 | +0 |  |
...
REQ 健全性診断は行数・関心数に加え、ステークホルダー視点（REQ-0101-079）と SPEC 分離基準（REQ-0101-068）に基づく次の検出パターンを追加する（REQ-0108-284、AG-008、RU-20260722-02 合意、ADR-0139）。
