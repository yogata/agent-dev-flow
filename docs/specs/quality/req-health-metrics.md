...
| REQ | 要件行数 | 行数シグナル | 備考 |
|---|---|---|---|
| REQ-006 | 99 | +2 | case-auto。ライフサイクル段階混在で関心シグナル追加 |
| REQ-002 | 90 | +2 | アーティファクト責任分界。肥大化 |
| REQ-001 | 65 | +1 | 文書、REQ 管理基準 |
| REQ-004 | 65 | +1 | 要件定義、保存 |
| REQ-001 | 55 | +1 | ADR ライフサイクル |
| REQ-010 | 53 | +1 | docs-check / Validation |
| REQ-005 | 51 | +1 |  |
| v2:REQ-0140 | 41 | +0 |  |
| REQ-008 | 33 | +0 |  |
| REQ-009 | 33 | +0 |  |
| REQ-003 | 32 | +0 | コマンド、スキル責務分界 |
| REQ-006 | 32 | +0 |  |
| REQ-006 | 32 | +0 |  |
| REQ-006 | 28 | +0 |  |
| REQ-010 | 28 | +0 |  |
| REQ-010 | 26 | +0 |  |
| REQ-001 | 25 | +0 | REQ/SPEC/ADR 適正運用自動化 |
| REQ-006 | 24 | +0 |  |
| REQ-010 | 22 | +0 |  |
| REQ-010 | 21 | +0 |  |
| REQ-010 | 18 | +0 |  |
