...
各コマンドのfrontmatterに `implementation_pattern` を指定する（REQ-0103-015）。定義と対応表は [`reference/command-map.md`](../../.opencode/skills/agentdev-workflow-lifecycle/references/command-map.md) の「Implementation Pattern Taxonomy」セクションが SSoT である。
