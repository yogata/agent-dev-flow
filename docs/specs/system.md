...
旧REQ群（REQ-0001〜0040、retired）を現行仕様基準として再構成した新基準REQ群（REQ-0101〜0114）を主参照とする。旧REQは履歴として保持し、移行分類（migrated / retired-no-successor / historical-only）に基づき扱う（REQ-0109）。
