...
| local/local-generation.md | draft | ローカル版 OpenCode 生成 | link mode 導入フロー、更新運用、残存 GitHub 固有参照の違反判定基準、変換プロンプト廃止経緯（REQ-0141-028/029、ADR-0131。local-transform.md から一元化、当該ファイル削除は case-run の責務） |
