...
> **local-transform.md 統合**: 変換プロンプト廃止経緯、変換品質検証の読み替え、残存 GitHub 固有参照の違反判定基準を旧 `local-transform.md` から本ファイルへ一元化した（REQ-0141-028/029、ADR-0131）。`local-transform.md` の削除は case-run のファイル操作責務として行う。
