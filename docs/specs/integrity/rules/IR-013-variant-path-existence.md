...
| detection_method | command 本文から種別パス（variant path）抽出 → 存在確認。パス成分を囲む Markdown backtick（インラインコード修飾）はパス解決前に除去する（REQ-010-020） |
| affected_artifacts | [commands, templates] |
| related_req | [REQ-010-089-091, REQ-010-020] |
