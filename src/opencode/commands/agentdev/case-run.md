...
複数 Issue の一括実行、Wave 順序制御にまたがるオーケストレーションは case-auto の責務（workflow-contracts SPEC SC-008、doc-input 経由で解決）。
...
2. `.agentdev/doc-inputs/commands/case-run.yaml` を読み込む
