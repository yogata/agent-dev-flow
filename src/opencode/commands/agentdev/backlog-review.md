...
2. `.agentdev/read-contracts/commands/backlog-review.yaml` を読み込む
...
**暫定分類付与（REQ-0155-004）**: 各 RU 候補について、document-model SPEC（read contract 経由）の文書7分類モデル（REQ、挙動SPEC、カタログSPEC、guide、learning維持、作業記録、対象外）を参照して暫定分類を付与する。
