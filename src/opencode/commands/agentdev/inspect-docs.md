...
11. **docs-check route判定**: 意味的疑いのうち機械的検査に落とせるものを docs-check ルール／検査データ候補として提示
12. **未処理artifact確認**: `agentdev-req-structure-diagnostics` 参照
13. **検出事項出力**: 検出事項を `.agentdev/inspect/inbox/inspect-docs-finding-{timestamp}.md` へ出力。source-of-truth priority: 現行 REQ > 承認済み ADR > SPEC > DOC-MAP/guides
