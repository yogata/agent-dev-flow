...
| `/agentdev/case-auto` | 要件doc / Issue番号・URL | マージ済み + クローズ済み（req-save〜case-close自走） | 完了 |
...
| `/agentdev/inspect-docs` | docs全体の意味整合検出 | inspect finding | `/agentdev/inspect-promote` → `/agentdev/backlog-review` |
| `/agentdev/inspect-skills` | Command/Skill 参照妥当性検出 | inspect finding | `/agentdev/inspect-promote` → `/agentdev/backlog-review` |
| `/agentdev/inspect-promote` | inspect finding の分類・採用 | promoted artifact | `/agentdev/backlog-review` |
