...
| `/agentdev/diagnostics-docs` | docs全体の意味整合診断 | diagnostics finding | `/agentdev/diagnostics-promote` → `/agentdev/backlog-review` |
| `/agentdev/diagnostics-skills` | Command/Skill 参照妥当性診断 | diagnostics finding | `/agentdev/diagnostics-promote` → `/agentdev/backlog-review` |
| `/agentdev/diagnostics-promote` | diagnostic finding の分類・採用 | promoted artifact | `/agentdev/backlog-review` |
...
- [diagnostics-docs.md](./diagnostics-docs.md)
- [diagnostics-skills.md](./diagnostics-skills.md)
- [diagnostics-promote.md](./diagnostics-promote.md)
