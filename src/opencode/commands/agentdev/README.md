...
| `/agentdev/inspect-read-contracts` | project read contract 整合性検出 | 検出事項 | `/agentdev/inspect-promote` → `/agentdev/backlog-review` |
...
- [inspect-read-contracts.md](./inspect-read-contracts.md)
