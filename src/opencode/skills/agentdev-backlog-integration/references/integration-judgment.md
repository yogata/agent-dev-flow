...
**upstream handoff metadata 付与**: artifact が AgentDevFlow 本体の不具合・改善点を扱う場合、分析結果に `agentdev_handoff: true` を記録する。判定は `agentdev-workflow-lifecycle` の upstream handoff 判定に従う
