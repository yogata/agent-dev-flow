...
- promoted/archiveへの振り分け・Git永続化手順
...
| `/agentdev/intake-promote` | inbox item を review・分類・整形・振り分けし promoted/archive に永続化する |
...
- **agentdev-backlog-integration**: promoted artifact から RU への変換
