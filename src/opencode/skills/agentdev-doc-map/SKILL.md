...
| DOC-MAP | `docs/DOC-MAP.md` | 補助 | ドキュメント探索経路のインデックス（REQ-0101） |
| README | `docs/README.md`, 各サブディレクトリ README | 補助 | ドキュメントハブ・エントリポイント |

### DOC-MAP の位置づけ（REQ-0101）
...
| DOC-MAP 更新 | -- | DOC-MAPの更新は探索経路の更新であり、要件/判断/仕様の更新ではない（REQ-0101） |
...
- `req-save`: REQ/ADR 保存時に DOC-MAP への影響を確認（REQ-0101, 035）
- `case-run` Step 10: SPEC 更新時に DOC-MAP への影響を確認（REQ-0101）
- `case-close` Step 3: DOC-MAP と基準の整合性を検証
