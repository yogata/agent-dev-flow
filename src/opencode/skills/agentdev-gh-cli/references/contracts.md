...
基盤手続き一覧（REQ-0149-002）を UPDATE せず、拡張手続きとして新設する2手続き（REQ-0149-011）。I/O 手続き（REQ-0149-004）に属し、本文生成、完了判定を含まない。READ 手続きであるため WRITE 手続きの VERIFY 4観点は適用せず、代わりに事後条件（出力検証）を用いる。
