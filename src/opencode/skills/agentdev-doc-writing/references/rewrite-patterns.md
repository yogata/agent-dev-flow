...
英字許容リスト、訳語表（修飾語の日本語化、複合技術語の訳し方、専門カタカナ語、略語の扱い等）は [docs/specs/document-type-responsibilities.md](../../../../../docs/specs/document-type-responsibilities.md)「用語政策」節を SSoT とする。
本ファイルは重複記述しない。
