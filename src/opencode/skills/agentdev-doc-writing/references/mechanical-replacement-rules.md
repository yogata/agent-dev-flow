...
- backticks 識別子/一般名詞 判定閾値: [docs/specs/backticks-identifier-threshold.md](../../../../../docs/specs/backticks-identifier-threshold.md)（識別子 backticks 必須、一般名詞 backticks 任意の機械判定閾値。inspect-docs 検出処理が参照）
