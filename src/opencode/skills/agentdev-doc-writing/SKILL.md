...
執筆規範の原本は `japanese-tech-writing` スキル（AGENTS.md 経由で参照）、配置基準、用語政策の原本は [docs/specs/document-type-responsibilities.md](../../../../../docs/specs/document-type-responsibilities.md) である。
