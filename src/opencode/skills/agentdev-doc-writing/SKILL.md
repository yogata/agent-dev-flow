...
原本は [docs/specs/writing-style.md](../../../../../docs/specs/writing-style.md) である。本スキルはその実行入口であり、`references/*` は運用ビュー（圧縮ビュー・チェックリスト・出力形式）である。内容が重複する場合、原本を優先する（REQ-0140-023）。
