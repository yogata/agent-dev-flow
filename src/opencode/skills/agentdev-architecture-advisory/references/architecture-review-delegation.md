...
配布 SKILL.md は相談プロトコル知識（入力テンプレート、4 ラベル構造、分類権限）を提供し、起動方法の具体は本ファイルおよび AGENTS.md、references/<harness>.md に配置する（REQ-0162-002、ADR-0136）。

## 起動方法

アーキテクチャ助言サブエージェントの起動手段、実行制御パラメータは AGENTS.md および references/<harness>.md 参照（REQ-0162-002）。
