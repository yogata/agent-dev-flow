...
> **原本**: [docs/specs/responsibilities/document-type-responsibilities.md](../../../../../docs/specs/responsibilities/document-type-responsibilities.md)「実行主体分類の査読基準」。
> 本ファイルは inspect-skills 診断観点「実行主体分類の誤認」（REQ-0125-010）の判定基準詳細を集約する運用ビューである。
