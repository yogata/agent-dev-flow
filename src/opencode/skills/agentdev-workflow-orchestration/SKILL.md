...
Wave 構成時に、各 Wave 内の Issue のファイル変更範囲が重複しないことを確認する（REQ-0106-027）。
...
- **case-run コマンド（source/authoring）**: `src/opencode/commands/agentdev/case-run.md` — 開発リポジトリ内でのみ参照可能。command の改修・拡張時に使用
...
- **ADR-0108**: Orchestration skill作成基準
