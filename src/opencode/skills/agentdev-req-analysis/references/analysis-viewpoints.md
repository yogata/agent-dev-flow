...
project 固有の判断知識は、利用者承認を経て backlog-review が docs/knowledge/ へ直接保存する正規昇華経路（バックログ統合の要件が正規所有する知識文書保存契約、REQ-056）を経由して流入し、リスク導出規則として次の分析で使われる成長する資産として扱う。
