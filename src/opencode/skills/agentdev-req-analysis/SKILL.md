...
---
<!-- ADF-COVERS(implementation): REQ-001-048, REQ-001-049, REQ-001-050 -->
<!-- ADF-COVERS(implementation): REQ-004-007, REQ-004-008, REQ-004-009, REQ-004-024, REQ-004-025, REQ-004-026, REQ-004-027, REQ-004-028, REQ-004-029, REQ-004-030, REQ-004-031, REQ-004-032, REQ-004-033, REQ-004-050, REQ-004-051, REQ-004-052 -->
...
本スキルの原本仕様は `agentdev-req-analysis` Design である。
...
- **扱う**: 分析観点、品質基準、壁打ちメソドロジー、REQ/Design 境界判定基準、Decision 閾値判定ブリッジ
- **扱わない**:
...
| 条件 | 読む reference |
|---|---|
| 要件展開の観点、完了条件、境界条件、必達要件記述、状態要件/反映作業分離、REQ/Design 境界判定基準、チェックボックス品質基準、ADR 閾値判定ブリッジ、分析フレーム選択、両面分析規定が必要な場合 | [references/analysis-viewpoints.md](references/analysis-viewpoints.md) |
