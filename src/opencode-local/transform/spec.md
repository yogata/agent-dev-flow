...
ローカル版生成が遵守するガードレール（REQ-0141-014, AG-009, AG-010）。本ファイルが正本であり、`transform/generate.md` は参照する。
...
変換後に生成レポートを出力する。レポートの必須項目（REQ-0141-028, AG-009）。本ファイルが正本であり、`transform/generate.md` は参照する。
