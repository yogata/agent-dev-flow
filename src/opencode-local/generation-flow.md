...
- `src/opencode-local/agentdev-gh-cli/case-schema/` — Case ファイルスキーマ定義
...
`.agentdev/cases/` 配下の Case ファイルはリポジトリ管理対象とする（REQ-0141-016、詳細は `agentdev-gh-cli/case-schema/case-file.md` 参照）。
