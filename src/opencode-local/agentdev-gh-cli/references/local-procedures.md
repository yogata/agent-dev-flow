...
Case ファイルスキーマの意味仕様の正本は SPEC [local-case-file.md](../../../../../docs/specs/local-case-file.md)。操作用定義は [../case-schema/case-file.md](../case-schema/case-file.md)。
...
採番規則の意味仕様は SPEC [local-case-file.md](../../../../../docs/specs/local-case-file.md) の「採番規則」セクション、運用参照資料は [../case-schema/case-file.md](../case-schema/case-file.md) の「採番規則」セクション参照。
...
`## マージ結果` の記録方針は SPEC [local-case-file.md](../../../../../docs/specs/local-case-file.md) の「マージ結果の記録方針」セクション参照。
...
`closed_at` の値条件は SPEC [local-case-file.md](../../../../../docs/specs/local-case-file.md) の「closed_at の値条件」セクション参照。

## status 状態遷移との協調

本手続きは Case ファイルの status 状態遷移の一部を担う。状態遷移表の全体は SPEC [local-case-file.md](../../../../../docs/specs/local-case-file.md) の「状態遷移表」、運用参照資料は [../case-schema/case-file.md](../case-schema/case-file.md) の「status enum と状態遷移」参照。
