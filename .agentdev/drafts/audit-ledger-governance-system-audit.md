...
- 解消状況（書き戻し）: 解消済。PR #1599（commit 28a00f86）でキャプションを「25件」に修正。Issue #1609 で再検証し実測 accepted 25件と一致を確認（U-003 解消）
...
- 解消状況（書き戻し）: 解消済。PR #1599（commit 28a00f86）で accepted リストへ ADR-0137 を追加。Issue #1609 で掲載を再確認（U-004 解消）
...
- 解消状況（書き戻し）: 解消済。PR #1599（commit 28a00f86）でトピック別ビュー「ワークフロー」分類へ ADR-0137 を追加。Issue #1609 で掲載を再確認（U-005 解消）
...
| docs/adr/README.md キャプション | accepted 25 件 | accepted 25 件 | 整合（不整合 #1 は PR #1599 で解消済、#1609 検証） |
| docs/adr/README.md 現行基盤ビュー表 | 25 行 | accepted 25 件 | 整合（表は正しい） |
| docs/adr/README.md ステータス別 accepted リスト | 25 件 | accepted 25 件 | 整合（不整合 #2 は PR #1599 で解消済、#1609 検証） |
