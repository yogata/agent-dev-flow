# 標準コアの索引・集約成果物の取扱い — デフォルト node_types 3種制約との整合再検討
...
- 索引・集約成果物がデフォルトコアでは構造問い合わせ対象から外れ、名称ベースの除外パターンが残存する
...
- SPEC: docs/specs/foundations/traceability-model.md「索引・集約成果物の役割識別」、docs/specs/skills/agentdev-artifact-graph.md 検証観点
- 出典: Issue #2190 (CLOSED), Epic #2189、PR #2198 (merged f4ac8d70)

## 出典

- 発生日: 2026-08-17
- 発生源: PR #2198 case-run 検証（Findings / Capture候補）
- 元 item: intake-2026-08-17-epic2189-index-role-default-core.md
