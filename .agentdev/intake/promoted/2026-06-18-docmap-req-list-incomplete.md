# docs/DOC-MAP.md の REQ 一覧が REQ-0133 で停止（REQ-0134/0135/0136 未掲載）
...
- AGENTS.md の REQ レンジ記載も同様に古い場合、複数箇所での不整合が拡大

## 既存要件との関連

- **REQ-0136-002**: 定量的データ検証（文書記載レンジと実ファイルの照合）
- **AGENTS.md「信頼できる情報源の優先順位」**: REQ レンジ記載（"REQ-0101〜REQ-0135" 等）
