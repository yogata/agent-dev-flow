# Capability Skill・SPEC に残る旧 command 番号（Step N）への参照
...
- 実番号化後の工程体系において解決先のない参照が残り、参照整合・導線の正確性を損なう

## 課題

command 再構成（OU-003 系）との整合を見ながら参照先更新の個別 Issue 化を推奨する。stale 参照（workflow-orchestration の case-run Step 6）は優先的に除去する。
...
- 発生日: 2026-08-16
- 発生源: PR #2153 (Issue #2144 / OU-010, Epic #2134 Wave 2) Findings / Capture候補 セクション intake 1
- 元 item: intake-2026-08-16-ou010-capability-spec-old-step-references.md
