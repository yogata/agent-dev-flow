...
- **実行日時**: 2026-06-05 14:32
- **スキャン対象**: REQ 14件、ADR 18件、Skill 21件、Command 17件、Guides 10件、Specs 9件、RetiredREQ 50件、DocMap 1件
...
- **[NG]** legacy-namespace: Legacy pattern '/case-open (bare slash form)' found (.opencode/commands/agentdev/case-auto.md)
- **[NG]** legacy-namespace: Legacy pattern '/case-run (bare slash form)' found (.opencode/commands/agentdev/case-auto.md)
- **[NG]** legacy-namespace: Legacy pattern '/case-close (bare slash form)' found (.opencode/commands/agentdev/case-auto.md)
...
- **[NG]** expanded-legacy-namespace: Legacy pattern '/case-open (bare slash form)' found (.opencode/commands/agentdev/case-auto.md)
- **[NG]** expanded-legacy-namespace: Legacy pattern '/case-run (bare slash form)' found (.opencode/commands/agentdev/case-auto.md)
- **[NG]** expanded-legacy-namespace: Legacy pattern '/case-close (bare slash form)' found (.opencode/commands/agentdev/case-auto.md)
...
- **[NG]** expanded-legacy-namespace: Legacy pattern '/case-open (bare slash form)' found (docs/specs/system.md)
- **[NG]** expanded-legacy-namespace: Legacy pattern '/case-run (bare slash form)' found (docs/specs/system.md)
...
- **[NG]** workflow-status-prohibition: Workflow status / 6 micro-phase state management pattern detected in REQ/SPEC (docs/requirements/REQ-0105.md:65) → route: intake
  ...
  - expected: `REQ/SPEC must not define workflow status state management`
- **[NG]** workflow-status-prohibition: Workflow status / 6 micro-phase state management pattern detected in REQ/SPEC (docs/requirements/REQ-0105.md:70) → route: intake
  - evidence: `### backlog-review draft の status フィールドについて（INC-0019 対応注記）`
  - expected: `REQ/SPEC must not define workflow status state management`
- **[NG]** workflow-status-prohibition: Workflow status / 6 micro-phase state management pattern detected in REQ/SPEC (docs/requirements/REQ-0105.md:72) → route: intake
  - evidence: `REQ-0105-041 ~ 044 が参照する `status: reviewed` / `status: saved` は、backlog-review draft（`.sisyphus/drafts/`）の軽量ドキュメントライフサイクル注記である。これらは REQ-0108-123 が禁止するワークフロー状態管理モデル（6 マイクロフェーズによる進行管理）ではなく、backlog-review → backlog-save 間の受け渡し成立条件を示す 2 値フラグである。実際の draft 生成・状態遷移の実装は backlog-review / backlog-save コマンドが担う。`
  - expected: `REQ/SPEC must not define workflow status state management`
...
### ReferencePath
- **[NG]** reference-path-existence: Referenced path does not exist: references/git-common-procedures.md (.opencode/commands/agentdev/case-close.md:35) → route: intake
  - evidence: `references/git-common-procedures.md`
  - expected: `file must exist at references/git-common-procedures.md`
- **[NG]** reference-path-existence: Referenced path does not exist: references/git-common-procedures.md (.opencode/commands/agentdev/case-close.md:51) → route: intake
  - evidence: `references/git-common-procedures.md`
  - expected: `file must exist at references/git-common-procedures.md`
- **[NG]** reference-path-existence: Referenced path does not exist: references/git-common-procedures.md (.opencode/commands/agentdev/case-close.md:66) → route: intake
  - evidence: `references/git-common-procedures.md`
  - expected: `file must exist at references/git-common-procedures.md`
- **[NG]** reference-path-existence: Referenced path does not exist: references/capture-boundaries.md (.opencode/commands/agentdev/case-close.md:72) → route: intake
  - evidence: `references/capture-boundaries.md`
  - expected: `file must exist at references/capture-boundaries.md`
- **[NG]** reference-path-existence: Referenced path does not exist: references/git-common-procedures.md (.opencode/commands/agentdev/case-close.md:75) → route: intake
  - evidence: `references/git-common-procedures.md`
  - expected: `file must exist at references/git-common-procedures.md`
