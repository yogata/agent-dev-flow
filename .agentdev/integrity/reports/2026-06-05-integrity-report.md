...
- **[WARNING]** accepted-adr-only-citation: Non-accepted ADR ADR-0007 (status: superseded) cited in docs/requirements/REQ-0112.md (docs/requirements/REQ-0112.md) → route: intake
  - evidence: `ADR-0007`
  - expected: `only accepted ADRs should be cited as current basis`
...
- **[WARNING]** accepted-adr-only-citation: Non-accepted ADR ADR-0014 (status: superseded) cited in docs/requirements/REQ-0112.md (docs/requirements/REQ-0112.md) → route: intake
  - evidence: `ADR-0014`
  - expected: `only accepted ADRs should be cited as current basis`
- **[WARNING]** accepted-adr-only-citation: Non-accepted ADR ADR-0015 (status: superseded) cited in docs/requirements/REQ-0112.md (docs/requirements/REQ-0112.md) → route: intake
  - evidence: `ADR-0015`
  - expected: `only accepted ADRs should be cited as current basis`
